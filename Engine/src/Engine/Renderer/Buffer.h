...
namespace Engine
{
	...
	static uint32_t ShaderDataTypeSize(ShaderDataType _type)
	{
		...
		case Engine::ShaderDataType::Float: return sizeof(float);
		case Engine::ShaderDataType::Float2: return sizeof(float) * 2;
		case Engine::ShaderDataType::Float3: return sizeof(float) * 3;
		case Engine::ShaderDataType::Float4: return sizeof(float) * 4;
		case Engine::ShaderDataType::Mat3: return sizeof(float) * 3 * 3;
		case Engine::ShaderDataType::Mat4: return sizeof(float) * 4 * 4;
		case Engine::ShaderDataType::Int: return sizeof(int);
		case Engine::ShaderDataType::Int2: return sizeof(int) * 2;
		case Engine::ShaderDataType::Int3: return sizeof(int) * 3;
		case Engine::ShaderDataType::Int4: return sizeof(int) * 4;
		case Engine::ShaderDataType::Bool: return sizeof(bool);
		}
